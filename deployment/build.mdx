...
**Solution**: Ensure variables are prefixed with `VITE_` and properly set in your hosting platform. See the [Hosting Guide](/deployment/hosting#environment-variables).
